    ...
    <div class="space-y-6 pb-8">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <span class="text-xs text-gray-500 dark:text-gray-400">({{ __('Mstari mwekundu = ada chini ya mahitaji ya msimu.') }})</span>
            </div>
        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('students.import') }}" enctype="multipart/form-data" class="space-y-5">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">{{ __('Safu: Jina kamili, Simu (contact), Barua pepe (email).') }}</p>
